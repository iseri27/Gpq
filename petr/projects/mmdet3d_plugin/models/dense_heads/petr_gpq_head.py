...
class PETRGpqHead(AnchorFreeHead):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if class_weight is not None and (self.__class__ is PETRGpqHead):
        ...
        super(PETRGpqHead, self).__init__(num_classes, in_channels, init_cfg=init_cfg)
    ...
    def _load_from_state_dict(
        ...
        if (version is None or version < 2) and self.__class__ is PETRGpqHead:
            convert_dict = {
